            ...
            <div class="center_column col-md-9 col-xs-12 col-sm-12" id="center_column">
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading bg-white" style="text-align: center">
                        عذرًا لا يوجد تقييمات لهذا المتجر في الوقت الحالي
                    </h2>
                    </div>
                      @endif  
                    <!-- PRODUCT LIST -->
                        
                        <div id="reviews" class="tab-panel" style="    background: #fff;
    margin-top: 30px;
    padding: 30px 0;">
                                ...
                                @foreach($ratings as $rating)
                                    <div class="comment row">
                                        ...
                                        <div class="col-sm-9 commnet-dettail" style="    text-align: right;
    padding-right: 30px;">
                                            {{$rating->comment}}
                                        </div>
                                    </div>
