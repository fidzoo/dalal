...
@if($sub_cat->ar_banner != null)
{!! HTML::image($sub_cat->ar_banner, "", ["width"=>250, "height"=>100]) !!}<br><br>
@endif
{!! Form::label('بنر القسم النسخة العربية') !!}
{!! Form::file('ar_banner') !!}<br>

@if($sub_cat->en_banner != null)
{!! HTML::image($sub_cat->en_banner, "", ["width"=>250, "height"=>100]) !!}<br><br>
@endif
