                ...
                <div class="page-content page-order ">
                    ...
                    <div class="top">
                        ...
                        <div class="order-detail-content">
                        	...
                        	<!-- Table On Desktop -->
                            <table class="table table-bordered table-responsive cart_summary hidden-sm hidden-xs">
                                <thead>
                                    <tr>
                                        <th>إسم المنتج</th>
                                        <th>سعر الوحدة</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="price">       
                                            ...
                                            <span class="price offerd-price">{{$product->price - $product->model->offer_price}} {{Session::has('currency') ? Session::get('currency') : 'رس'}}</span>
                                            @else
                           ...
                           <!-- New Table On Tablet And Mobile -->
                           
                            @foreach($content as $product)
                            <table class="table table-bordered table-responsive cart_summary hidden-lg hidden-md">
                                <tbody>
                            ...
                            @endforeach
                            <!-- End of Table On Tablet And Mobile -->
                            ...
                            <div class="cart_navigation row">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12  pull-left">
                                	<a class="prev-btn" href="#">متابعة الشراء</a>
                                </div> 
                            </div>
